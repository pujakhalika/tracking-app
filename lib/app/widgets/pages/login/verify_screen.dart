...
import 'package:besafe/app/controllers/auth/verify/verify_controller.dart';
/* import 'package:besafe/app/backend/supabase/client/auth_client.dart'; */
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller: verifyController.emailC,
                ...
                const SizedBox(height: 20),
                const Text(
                  'Enter your email address and we will send you a link to generate OTP.',
                  style: TextStyle(
                    fontSize: 16,
                    fontFamily: 'HinaMincho',
                  ),
                ...
                ElevatedButton(
                  onPressed: () async {
                    await AuthService(client).sendVerify(
                      verifyController.emailC.text,
                    );
                  },
